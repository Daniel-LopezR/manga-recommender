...
function Toast({ type, message }: { type: toastType; message?: string }) {
  ...
  return (
    <div
      className={`fixed top-3 right-3 bg-transparent shadow-lg mx-auto w-96 max-w-full text-sm pointer-events-auto bg-clip-padding rounded-lg block mb-3 ${styles["toast-animation"]}`}
      id="toast"
      aria-live="assertive"
      aria-atomic="true"
